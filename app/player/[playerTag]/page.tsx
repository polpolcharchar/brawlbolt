    ...
    playerData[activePlayerTag] ? (
      <div className="flex flex-1 flex-col gap-4 p-4">
        <div className="grid auto-rows-min gap-4 md:grid-cols-2">
          <Card className="bg-muted/50 rounded-xl text-center border-none">
            <div>
              <p className="text-6xl font-bold">{playerData[activePlayerTag].name}</p>
              <p className="text-2xl text-gray-500">#{activePlayerTag}</p>

            </div>
            <div className='text-2xl text-(--foreground) font-bold items-center'>
          ...
          <div className="bg-muted/50 flex-1 rounded-xl md:min-h-min flex flex-col items-center">
            {playerOverview && (
