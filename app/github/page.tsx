...
export default function UserPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[90svh] px-4 py-12 space-y-10">
            <Card className="max-w-xl text-center p-2 border rounded-md">
                <h1 className="text-4xl font-bold tracking-tight mb-4">BrawlBolt GitHub</h1>
                <section className="">
                    <h3 className="mb-4 text-xl font-semibold text-gray-200 mb-2">BrawlBolt is an open-source project. README's may be outdated. To learn more, visit these GitHub repositories:</h3>
